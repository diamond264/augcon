...
CONFIG_PATH = '/mnt/sting/hjyoon/projects/aaa/configs/imwut/main_hps_finetune'
MODEL_PATH = '/mnt/sting/hjyoon/projects/aaa/models/imwut/main_hps_finetune'
...
def get_config(mode, gpu, port, dataset_name, data_path, num_cls,
               criterion, lr, ckpt_path, pretrained, freeze):
