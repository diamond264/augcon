...
if __name__ == '__main__':
    ...
    # rm -rf /mnt/sting/hjyoon/projects/aaa/configs/imwut/main_hps_finetune_fix/*/metaautoencoder/
    # rm -rf /mnt/sting/hjyoon/projects/aaa/configs/imwut/main_hps_finetune_fix/*/autoencoder/

    # python scripts/parse_results/imwut_exp/analyze_finetuned_hps.py --pretext autoencoder --setting linear --dataset i
    # python scripts/parse_results/imwut_exp/analyze_finetuned_hps_meta.py --pretext metaautoencoder --dataset i