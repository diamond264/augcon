...
PRETRAIN_HPS = {
    'ichar': {'lr': 0.001, 'wd': 0.0001, 'bs': 1024, 'tlr': 0.001},
    'hhar': {'lr': 0.001, 'wd': 0.0, 'bs': 1024, 'tlr': 0.01},
    'pamap2': {'lr': 0.0005, 'wd': 0.0001, 'bs': 1024, 'tlr': 0.01},
    'dsa': {'lr': 0.001, 'wd': 0.0001, 'bs': 1024, 'tlr': 0.001}
}
...
def gen_pretrain_config():
    for dataset in DATASETS:
        ...
        for domain in domains:
            ...
            epochs = 100
            lr, wd, bs, tlr = param['lr'], param['wd'], param['bs'], param['tlr']
            ...
            pretrain_config = get_config('pretrain', [gpu], port, dataset,
                                         ...
                                         epochs, bs, lr, wd, pretrain_ckpt_path, None, True, 0, tlr)
                ...
                for shot in [1, 2, 5, 10, 20]:
                    for freeze in [True]:
                        ...
                        finetune_config = get_config('finetune', [gpu], port, dataset,
                                                        ...
                                                        pretrained_path, freeze, seed, tlr)
...
def get_config(mode, gpu, port, dataset_name, data_path, num_cls,
               criterion, epochs, bs, lr, wd, ckpt_path, pretrained, freeze, seed, tlr):
    config = f'''mode: {mode}
seed: {seed}
gpu: {gpu}
