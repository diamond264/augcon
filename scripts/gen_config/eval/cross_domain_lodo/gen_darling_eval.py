            ...
            for seed in [0,1,2,3,4]:
                for shot in [1, 2, 5, 10, 20]:
                    for freeze in [True, False]:
                        ...
                        finetune_config_path = f'{CONFIG_PATH}/{dataset}/darling/finetune_transfer_lodo/{shot}shot/{setting}/seed{seed}/gpu{gpu}_{domain}.yaml'
                        print(f'Generating {finetune_config_path}')

                        finetune_path = f'{data_path}{domain}/finetune/{shot}shot/target'
                        finetune_ckpt_path = f'{MODEL_PATH}/{dataset}/darling/finetune_transfer_lodo/{shot}shot/{setting}/seed{seed}/{domain}'
