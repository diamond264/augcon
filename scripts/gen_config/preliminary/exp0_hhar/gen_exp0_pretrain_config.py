...
config_path = '/home/hjyoon/projects/augcon/config/exp0_hhar/pretrain'
...
dataset_name: hhar
train_dataset_path: /mnt/sting/hjyoon/projects/cross/HHAR/augcon/{domain}/pretrain/train.pkl
test_dataset_path: /mnt/sting/hjyoon/projects/cross/HHAR/augcon/{domain}/pretrain/test.pkl
val_dataset_path: /mnt/sting/hjyoon/projects/cross/HHAR/augcon/{domain}/pretrain/val.pkl
input_channels: 3
num_cls: 9
'''
...
resume: ''
ckpt_dir: /mnt/sting/hjyoon/projects/augcontrast/models/exp0_hhar/pretrain/without_{domain}/{ckpt_name}
log_freq: 20
save_freq: {save_freq}
'''
