...
PRETRAIN_HPS = {
    'ichar': {'lr': 0.001, 'wd': 0.0, 'tlr': 0.01},
    'hhar': {'lr': 0.0005, 'wd': 0.0, 'tlr': 0.005},
    'pamap2': {'lr': 0.001, 'wd': 0.0, 'tlr': 0.001},
...
EPOCHS = {
    ...
    'target_user_a_model_s3': 2999,
    'target_user_c_model_s3': 1999,
    'target_user_f_model_s3': 4999,
    'target_user_a_model_s3mini': 4999,
    'target_user_c_model_s3mini': 1999,
    'target_user_f_model_s3mini': 3999,
    'target_user_a_model_lgwatch': 4999,
    'target_user_c_model_lgwatch': 3999,
    'target_user_f_model_lgwatch': 4999,
    'target_user_b_model_nexus4': 3999,
    'target_user_d_model_nexus4': 2999,
    'target_user_b_model_s3': 4999,
    'target_user_d_model_s3': 4999,
    'target_user_b_model_s3mini': 4999,
