    ...
    def __init__(self, file, class_type, seq_len=256,
        ...
        self.metadata = {
            ...
            'activity': ['walking', 'running', 'sitting',
                         'standing', 'lying', 'stairup',
                         'stairdown', 'jumping', 'stretching']
        }
...
if __name__ == '__main__':
    file_path = '/mnt/sting/hjyoon/projects/cross/ICHAR/ichar_minmax_scaling_all.csv'
    base_out_dir = '/mnt/sting/hjyoon/projects/cross/ICHAR/augcon'
    ...
    dataset = ProcessICHAR(file_path, 'activity')
