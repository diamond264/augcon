...
class ProcessDSA():
    def __init__(self, file, class_type, seq_len=256,
        ...
        self.metadata = {
            'domain': ['T', 'RA', 'LA', 'RL', 'LL'],
            'activity': ['sitting', 'standing', 'lying_on_back', 'lying_on_right',
       'ascending_stairs', 'descending_stairs', 'standing_in_elevator',
       'moving_in_elevator', 'walking_in_parking_lot',
       'walking_on_treadmill_4_flat', 'walking_on_treadmill_4_inclined',
       'running_on_treadmill_8', 'exercising_on_stepper',
       'exercising_on_cross_trainer', 'cycling_on_bike_horizontal',
       'cycling_on_bike_vertical', 'rowing', 'jumping',
       'playing_basketball']
        }
...
if __name__ == '__main__':
    file_path = '/mnt/sting/hjyoon/projects/cross/DSA/modified_mms_all.csv'
    base_out_dir = '/mnt/sting/hjyoon/projects/cross/DSA/augcon'
    
    class_type = 'activity'
    domains = ['T', 'RA', 'LA', 'RL', 'LL']
    
    dataset = ProcessDSA(file_path, 'activity')
